...
def start_time():
    ...
    if reps % 8 == 0:
        ...
        timer.columnconfigure(text='Break', fg=PINK)
    else:
        count_down(work_sec)
        timer.columnconfigure(text='Work', fg=GREEN)
...
tomato_img = PhotoImage(file='/Users/a.musialke/Documents/IT/day-28/pomodoro-start/tomato.png')
